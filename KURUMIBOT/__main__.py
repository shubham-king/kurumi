...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an [RUSSONET](https://telegra.ph/file/b296885ac8dc41438a4ac.jpg)  group management bot. I will use my  protect to  your group. You can find my list of available commands with /help.
"""
...
For all command use / [or](https://telegra.ph/file/b296885ac8dc41438a4ac.jpg) ! 
""".format(
    dispatcher.bot.first_name, ""
    if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\nKindly use ! for commands if / is not working\n")

TOKISAKI_IMG = "https://telegra.ph/file/b296885ac8dc41438a4ac.jpg"
KURUMI_IMG = "https://telegra.ph/file/b296885ac8dc41438a4ac.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Click here to donate in [Paypal](https://t.me/robottech_memeber)"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="🔺Add RUSSONET to your group🔻",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🌟 Global Federation 🌟",
                             url="https://t.me/MAHAKAL_FED_NETWORK")
                    ]]))
        ...
        update.effective_message.reply_video(
                KURUMI_IMG, caption=f"RUSSONET!!!!\nI'm here with my RUSSONET")
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[My Zaphkiel won't let me die!](https://telegra.ph/file/b296885ac8dc41438a4ac.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
